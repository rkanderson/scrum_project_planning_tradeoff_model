...
results_list$results_summary %>% kable()
...
# just reset the planning scope constant
PLAN_SCOPE <- 5
...
# What if the k-value was less?

I had k set to 40, which is a lot. What if we changed our assumptions about C and K?
What if instead of 10% we made it 1%. So that if we spent 400 hours on planning, only 4 of thohse hours 
would form the constant component 

C = 15.84
K = 4

```{r}
# Reset the constants of C and K
C <- 15.84
K <- 4
```
